 ...
 */
public class MethodMonitor extends AppCompatPreferenceActivity {
    public static String LUAPATH = "/data/data/edu.utd.s3.cszuo.methodmonitor/lua";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Process p = Runtime.getRuntime().exec("chmod 777 " + destDir);
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), MethodMonitor.class));
                return true;
            }
